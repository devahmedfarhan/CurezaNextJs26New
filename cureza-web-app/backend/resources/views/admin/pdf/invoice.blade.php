...
<body>
  @php
    // Determine dynamic logo loading path
    $logo_paths = [
      ...
      <table class="items-table">
        ...
        <tbody>
          ...
          @foreach($order->items as $index => $item)
            ...
            @endphp
            <tr>
              <td style="text-align: center; color: #64748b; vertical-align: middle;">{{ $index + 1 }}</td>
              <td>
              ...
              <td style="text-align: right; vertical-align: middle;">
                ...
                @else
                  ...
                  <div class="text-xs text-muted" style="font-size: 8px; line-height: 1.1;">IGST ({{ number_format($item_slab, 1) }}%)</div>
                @endif
              </td>
