                ...
                <div className="relative z-10">
                    ...
                    <div className="mt-24 space-y-6">
                        ...
                        <p className="text-sm xl:text-base text-[#F8F3EF]/80 font-medium leading-relaxed max-w-md">
                            Manage users, verify seller/doctor applications, configure system parameters, and monitor transactions.
                        </p>
                    </div>
                    ...
                    <div className="mt-16 space-y-5">
                        <div className="flex items-center gap-4 group">
                            ...
                            <span className="text-sm font-bold text-[#F8F3EF]/90 group-hover:text-white transition-colors">Full Platform Authority & Auditing</span>
                        </div>
                        <div className="flex items-center gap-4 group">
                            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#F8F3EF]/5 border border-[#F8F3EF]/10 text-[#F0C417] transition-all duration-300 group-hover:bg-[#F8F3EF]/10">
                                <ShieldCheck size={20} />
                            </div>
                            <span className="text-sm font-bold text-[#F8F3EF]/90 group-hover:text-white transition-colors">User & Professional Approvals</span>
                        </div>
                        <div className="flex items-center gap-4 group">
                            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#F8F3EF]/5 border border-[#F8F3EF]/10 text-[#F0C417] transition-all duration-300 group-hover:bg-[#F8F3EF]/10">
                                <LockIcon size={20} />
                            </div>
                            <span className="text-sm font-bold text-[#F8F3EF]/90 group-hover:text-white transition-colors">Platform Security & Cryptographic Tokens</span>
                        </div>
                    </div>
                </div>

                <div className="relative z-10 text-xs text-[#F8F3EF]/50 font-bold uppercase tracking-widest">
                    © 2026 Cureza Wellness. Internal Control Portal.
                </div>
                ...
                <div className="w-full max-w-md space-y-8 bg-white border border-[#052326]/10 rounded-3xl p-8 md:p-10 shadow-xl shadow-[#052326]/5">
                    <div className="text-center lg:text-left space-y-2">
                        ...
                        <p className="text-xs text-gray-500 font-semibold leading-relaxed">
                            Access the super administration control panel.
                        </p>
                    </div>
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        <div className="space-y-4">
                            <div className="space-y-1">
                                <label htmlFor="email" className="text-xs font-black uppercase tracking-wider text-[#052326]/75">Admin Email</label>
