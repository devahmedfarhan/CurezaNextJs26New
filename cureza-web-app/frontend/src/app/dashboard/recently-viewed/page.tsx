    ...
    return (
        <div className="space-y-6">
            ...
            {loading ? (
                ...
                <div className="text-center py-20 bg-white dark:bg-gray-900 rounded-[10px] border-[0.5px] border-black/10 dark:border-white/5 shadow-sm max-w-2xl mx-auto">
                    <div className="w-16 h-16 bg-[#052326]/5 rounded-[10px] flex items-center justify-center mx-auto mb-6 text-[#052326]">
                        <Eye size={28} />
                    </div>
                    <h2 className="text-sm font-bold text-[#052326] dark:text-gray-200 mb-2">No recently viewed products</h2>
                    <p className="text-xs text-gray-500 mb-8 max-w-sm mx-auto">
                        Explore our store and check out our health and wellness products.
                    </p>
                    <Link
                        href="/shop"
                        className="px-6 py-2.5 rounded-[10px] bg-[#052326] text-white hover:bg-[#0b4435] transition-all text-xs font-bold shadow-sm inline-flex items-center gap-2"
                    >
