...
export default function DashboardOverviewPage() {
    ...
    return (
        <div className="space-y-8">
            {/* WELCOME BANNER CARD */}
            <div className="relative overflow-hidden bg-gradient-to-r from-[#052326] to-[#0b4435] text-[#F8F3EF] rounded-2xl p-6 md:p-8 shadow-md">
                ...
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                    <div>
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 backdrop-blur-md rounded-full text-xs font-bold text-[#F0C417] mb-4">
                    ...
                    <div className="flex items-center gap-4 bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-4 min-w-[200px]">
                        <div className="w-10 h-10 rounded-lg bg-[#F0C417]/20 flex items-center justify-center text-[#F0C417]">
                            <Trophy size={20} />
                        </div>
                        <div>
                            <span className="text-[10px] uppercase tracking-wider text-[#F8F3EF]/60 font-semibold block">Cureza Points</span>
                            <span className="text-lg font-extrabold text-[#F8F3EF]">{stats.points} pts</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl p-5 shadow-sm hover:shadow-md transition-all">
                    <div className="flex justify-between items-start">
                        <div className="p-2.5 bg-green-50 dark:bg-green-950/20 text-[#052326] dark:text-green-300 rounded-xl">
                            <Wallet size={20} />
                        </div>
                        <Link href="/dashboard/wallet" className="text-xs text-gray-400 hover:text-[#052326] flex items-center gap-0.5">
                            Manage <ArrowUpRight size={14} />
                        </Link>
                    </div>
                    <div className="mt-4">
                        <span className="text-xs text-gray-500 font-semibold uppercase tracking-wider block">Wallet Balance</span>
                        <span className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1 block">₹{stats.balance.toFixed(2)}</span>
                    </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl p-5 shadow-sm hover:shadow-md transition-all">
                    <div className="flex justify-between items-start">
                        <div className="p-2.5 bg-blue-50 dark:bg-blue-950/20 text-blue-600 dark:text-blue-300 rounded-xl">
                            <ShoppingBag size={20} />
                        </div>
                        <Link href="/dashboard/orders" className="text-xs text-gray-400 hover:text-[#052326] flex items-center gap-0.5">
                            View all <ChevronRight size={14} />
                        </Link>
                    </div>
                    <div className="mt-4">
                        <span className="text-xs text-gray-500 font-semibold uppercase tracking-wider block">Total Orders</span>
                        <span className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1 block">{stats.totalOrders} Orders</span>
                    </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl p-5 shadow-sm hover:shadow-md transition-all">
                    <div className="flex justify-between items-start">
                        <div className="p-2.5 bg-purple-50 dark:bg-purple-950/20 text-purple-600 dark:text-purple-300 rounded-xl">
                            <FileText size={20} />
                        </div>
                        <Link href="/dashboard/prescriptions" className="text-xs text-gray-400 hover:text-[#052326] flex items-center gap-0.5">
                    ...
                    <div className="mt-4">
                        ...
                        <span className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1 block">{stats.approvedPrescriptions} Active</span>
                    </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl p-5 shadow-sm hover:shadow-md transition-all">
                    <div className="flex justify-between items-start">
                        <div className="p-2.5 bg-yellow-50 dark:bg-yellow-950/20 text-yellow-600 dark:text-yellow-300 rounded-xl">
                            <Activity size={20} />
                        </div>
                        <Link href="/dashboard/challenges" className="text-xs text-gray-400 hover:text-[#052326] flex items-center gap-0.5">
                    ...
                    <div className="mt-4">
                        ...
                        <span className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1 block">{activeChallenges.length} Ongoing</span>
                    </div>
                </div>
            </div>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden flex flex-col justify-between">
                    <div>
                        <div className="p-6 border-b border-gray-50 dark:border-gray-800 flex justify-between items-center">
                            <h3 className="font-bold text-charcoal dark:text-gray-100 flex items-center gap-2">
                                <ShoppingBag size={18} className="text-[#052326]" />
                                Recent Orders
                            </h3>
                            <Link href="/dashboard/orders" className="text-xs font-bold text-cureza-green hover:underline">
                                View History
                            </Link>
                        </div>
                        ...
                        <div className="divide-y divide-gray-50 dark:divide-gray-800">
                            {recentOrders.length === 0 ? (
                                <div className="p-8 text-center text-gray-400 text-sm">
                                    No orders found. 
                                    <Link href="/shop" className="text-cureza-green font-bold block mt-1 hover:underline">
                                        Start shopping
                                    </Link>
                                </div>
                            ) : (
                                recentOrders.map((order) => (
                                    <div key={order.id} className="p-5 flex items-center justify-between hover:bg-gray-50/50 dark:hover:bg-gray-850 transition-colors">
                                        <div className="flex items-center gap-4">
                                            <div className="w-10 h-10 rounded-lg bg-gray-50 dark:bg-gray-800 flex items-center justify-center text-lg">
                                                📦
                                            </div>
                                            <div>
                                                <p className="font-bold text-sm text-charcoal dark:text-gray-100">Order #{order.order_number}</p>
                                                <p className="text-xs text-gray-400 mt-0.5">Placed on {new Date(order.created_at).toLocaleDateString()}</p>
                                            </div>
                                        </div>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm overflow-hidden flex flex-col justify-between">
                    <div>
                        <div className="p-6 border-b border-gray-50 dark:border-gray-800 flex justify-between items-center">
                            ...
                            <Link href="/dashboard/prescriptions" className="text-xs font-bold text-cureza-green hover:underline">
                                View all
                            </Link>
                        </div>
                        ...
                        <div className="divide-y divide-gray-50 dark:divide-gray-800">
                            {recentPrescriptions.length === 0 ? (
                                <div className="p-8 text-center text-gray-400 text-sm">
                                    ...
                                    <Link href="/doctor" className="text-cureza-green font-bold block mt-1 hover:underline">
                                        Consult a doctor
                                    </Link>
                                </div>
                            ) : (
                                recentPrescriptions.map((presc) => (
                                    <div key={presc.id} className="p-5 flex items-center justify-between hover:bg-gray-50/50 dark:hover:bg-gray-850 transition-colors">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p className="font-bold text-sm text-charcoal dark:text-gray-100">Prescription #{presc.prescription_number}</p>
                                                <p className="text-xs text-gray-400 mt-0.5">By Dr. {presc.doctor?.name || 'Authorized Doctor'}</p>
                                            </div>
                                        </div>
                                        <div>
                                            <Link 
                                                href={`/dashboard/prescriptions`}
                                                className="px-3 py-1.5 border border-cureza-green text-cureza-green rounded-lg text-xs font-semibold hover:bg-green-50 transition-all"
                                            >
                                                View PDF
                                            </Link>
                                        </div>
                ...
                <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-6 shadow-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        {activeChallenges.map((challenge) => (
                            <div key={challenge.id} className="bg-gray-50 dark:bg-gray-850 p-4 rounded-xl border border-gray-100/50 dark:border-gray-800/50">
                                <div className="flex justify-between items-start mb-2">
                                    <h4 className="font-bold text-sm text-charcoal dark:text-gray-100">{challenge.title}</h4>
                                    <span className="text-[10px] font-extrabold text-[#F0C417] bg-[#F0C417]/10 px-2 py-0.5 rounded-md">
