...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="customer-theme bg-[#F8F3EF] min-h-screen py-10 transition-colors duration-300">
            <div className="container mx-auto px-4 md:px-6">
                <div className="flex flex-col lg:flex-row gap-8 items-start">
                    
                    {/* SIDEBAR */}
                    <aside className="w-full lg:w-[280px] shrink-0 lg:sticky lg:top-24">
                        <div className="bg-white dark:bg-gray-900 rounded-[10px] shadow-[0_4px_25px_rgba(0,0,0,0.02)] border-[0.5px] border-black/50 overflow-hidden">
                            {/* Profile Info Header */}
                            <div className="p-6 bg-gradient-to-br from-[#052326]/5 to-[#052326]/[0.02] dark:from-gray-800/20 dark:to-gray-900/5 border-b-[0.5px] border-black/50">
                                <div className="flex items-center gap-4">
                                    <div className="w-12 h-12 bg-[#052326] text-white rounded-[10px] overflow-hidden flex items-center justify-center font-bold text-lg border-[0.5px] border-black/20 shrink-0 shadow-sm relative group">
                                    ...
                                    <div className="overflow-hidden flex flex-col">
                                        ...
                                        <div className="mt-1.5 self-start">
                                            <span className="inline-flex items-center text-[9px] font-bold bg-[#052326]/10 dark:bg-white/10 text-[#052326] dark:text-gray-200 px-1.5 py-0.5 rounded-[4px] border-[0.5px] border-[#052326]/10 dark:border-white/10 uppercase tracking-wider">
                                                Customer Account
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <div className="p-4 max-h-[calc(100vh-220px)] overflow-y-auto custom-scrollbar space-y-5">
                                ...
                                <div className="pt-2 border-t-[0.5px] border-black/50">
                                    <button
                                        onClick={() => logout()}
                    ...
                    <div className="flex-1 w-full flex flex-col gap-6">
                        ...
                        <header className="flex justify-end items-center px-6 py-3.5 bg-white dark:bg-gray-900 rounded-[10px] shadow-[0_4px_25px_rgba(0,0,0,0.02)] border-[0.5px] border-black/50">
