                                ...
                                <tr key={coupon.code} className="group hover:bg-gray-50/50 transition-colors">
                                    <td className="px-8 py-6">
                                        <div className="flex items-center gap-3">
                                            <div className="p-2 bg-gray-50 text-cureza-green rounded-xl border-[0.5px] border-black/50 group-hover:bg-white group-hover:scale-110 transition-all">
                                                <Tag size={16} />
                                            </div>
                                    ...
                                    <td className="px-8 py-6">
                                        <span className={`px-3 py-1 rounded-lg text-[10px] font-extrabold uppercase tracking-widest ${coupon.status === 'Active' ? 'bg-emerald-50 text-emerald-600 border-[0.5px] border-black/50' :
                                            'bg-gray-100 text-gray-400 border-[0.5px] border-black/50'
                                            }`}>
                                            {coupon.status}
                                        </span>
                                    </td>
