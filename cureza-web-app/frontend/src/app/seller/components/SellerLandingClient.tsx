...
import { 
    ...
    Lock, HelpCircle, Check, Users, ChevronRight
} from 'lucide-react';
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        ...
                        <div className="flex-1 space-y-8 text-center lg:text-left">
                            ...
                            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4 pt-4">
                                ...
                                <a
                                    href="/seller/login"
                                    className="px-8 py-4 border border-[#F8F3EF]/30 text-white font-bold rounded-[10px] hover:bg-white/10 transition duration-300 text-xs capitalize tracking-wider flex items-center justify-center gap-2"
                                >
                                    Seller Sign In
                                </a>
                            </div>
                        ...
                        <div className="flex-1 flex justify-center relative w-full max-w-[480px]">
                            ...
                            <div className="absolute top-[-20px] left-[-30px] bg-white text-[#052326] p-3 rounded-xl border border-[#052326]/10 shadow-xl flex items-center gap-3 animate-float-1 z-20">
                                ...
                                <div>
                                    <div className="text-[8px] font-bold text-gray-400 uppercase tracking-wider">Dr. Recommendation</div>
                                    <div className="text-xs font-bold text-emerald-700">Verified by Medical Panel</div>
                                </div>
                            </div>
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="p-8 bg-[#F8F3EF]/50 rounded-[12px] border border-[#052326]/5 hover:border-[#052326]/40 transition duration-300 group">
                            ...
                            <p className="text-gray-600 text-sm leading-relaxed">
                                Products pass validation tests to guarantee authentic ingredients. This build high-level consumer trust that traditional platforms lack.
                            </p>
                        </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        ...
                        <div className="bg-[#F8F3EF]/30 p-8 rounded-[12px] border border-[#052326]/8 text-center flex flex-col justify-between space-y-6">
                            <div className="space-y-4">
                                ...
                                <div className="text-3xl font-black text-[#052326] tracking-tight">22% – 27%</div>
                                <p className="text-gray-500 text-xs leading-relaxed">
                                    Determined by the specific product wellness category and volume tier.
                                </p>
                            </div>
                            <div className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">No Sales, No Fees</div>
                        </div>
                        ...
                        <div className="bg-[#F8F3EF]/30 p-8 rounded-[12px] border border-[#052326]/8 text-center flex flex-col justify-between space-y-6">
                            <div className="space-y-4">
                                ...
                                <div className="space-y-1">
                                    <div className="text-xl font-bold text-[#052326] tracking-tight">India: 2.50%</div>
                            ...
                            <div className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Secure Payment Pipes</div>
                        </div>
                        ...
                        <div className="bg-[#F8F3EF]/30 p-8 rounded-[12px] border border-[#052326]/8 text-center flex flex-col justify-between space-y-6">
                            <div className="space-y-4">
                                ...
                                <div className="text-lg font-bold text-[#052326] tracking-tight">Minimal Slabs</div>
                                <p className="text-gray-500 text-xs leading-relaxed">
                                    A highly transparent closing fee model determined by item price brackets and weight slabs.
                                </p>
                            </div>
                            <div className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">Transparent Ledger</div>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div className="space-y-12">
                            ...
                            <div className="flex flex-col md:flex-row items-start md:items-center gap-8 relative">
                                ...
                                <div className="flex-1 md:text-right pl-12 md:pl-0 md:pr-16">
                                    <h4 className="text-xl font-bold text-[#052326] mb-2 font-heading">Register Your Brand</h4>
                            ...
                            <div className="flex flex-col md:flex-row items-start md:items-center gap-8 relative">
                                ...
                                <div className="flex-1 pl-12 md:pl-16">
                                    <h4 className="text-xl font-bold text-[#052326] mb-2 font-heading">Upload Catalog & Licensing</h4>
                            ...
                            <div className="flex flex-col md:flex-row items-start md:items-center gap-8 relative">
                                ...
                                <div className="flex-1 md:text-right pl-12 md:pl-0 md:pr-16">
                                    <h4 className="text-xl font-bold text-[#052326] mb-2 font-heading">Get Verified & Doctor Certified</h4>
                                    <p className="text-gray-500 text-sm leading-relaxed max-w-md md:ml-auto">
                            ...
                            <div className="flex flex-col md:flex-row items-start md:items-center gap-8 relative">
                                ...
                                <div className="flex-1 hidden md:block"></div>
                                <div className="flex-1 pl-12 md:pl-16">
                                    <h4 className="text-xl font-bold text-[#052326] mb-2 font-heading">Start Selling & Ship</h4>
                                    <p className="text-gray-500 text-sm leading-relaxed max-w-md">
                            ...
                            <div className="flex flex-col md:flex-row items-start md:items-center gap-8 relative">
                                ...
                                <div className="flex-1 md:text-right pl-12 md:pl-0 md:pr-16">
                                    <h4 className="text-xl font-bold text-[#052326] mb-2 font-heading">Weekly Bank Payouts</h4>
                                    <p className="text-gray-500 text-sm leading-relaxed max-w-md md:ml-auto">
