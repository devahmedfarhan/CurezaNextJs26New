...
import { Mail, ArrowRight, ArrowLeft, Shield, Key, Lock, Loader2, CheckCircle, RefreshCw, Store } from 'lucide-react';
    ...
    const handleSendOtp = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (data.action === 'register_required') {
                setError('This email is not registered as a seller. Please verify your email or sign up.');
                setLoading(false);
                return;
            }
