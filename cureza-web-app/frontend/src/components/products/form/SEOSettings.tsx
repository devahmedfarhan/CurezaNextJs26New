...
export default function SEOSettings({ formData, handleInputChange, isSuperAdmin }: SEOSettingsProps) {
    ...
    const getProgressColor = (current: number, max: number) => {
        ...
        return isSuperAdmin ? 'bg-black dark:bg-white' : 'bg-cureza-green';
    };
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="group space-y-3">
                            <div className="flex justify-between items-end">
                                <div className="space-y-1">
                                    <label className={`block text-xs font-black text-gray-400 ${isSuperAdmin ? 'capitalize' : 'uppercase'} tracking-widest pl-1`}>Meta Title</label>
                        ...
                        <div className="group space-y-3">
                            <div className="flex justify-between items-end">
                                <div className="space-y-1">
                                    <label className={`block text-xs font-black text-gray-400 ${isSuperAdmin ? 'capitalize' : 'uppercase'} tracking-widest pl-1`}>Meta Description</label>
                ...
                <div className="w-full xl:w-[450px] space-y-6 pt-2">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <h4 className={`text-xs font-black text-gray-400 ${isSuperAdmin ? 'capitalize' : 'uppercase'} tracking-widest`}>Google Simulator</h4>
                        </div>
                        <div className={`px-3 py-1 bg-gray-100 dark:bg-gray-800 ${isSuperAdmin ? 'rounded-md' : 'rounded-full'}`}>
                            <p className={`text-[10px] font-bold text-gray-400 ${isSuperAdmin ? 'capitalize' : 'uppercase'} tracking-tighter`}>Live Preview</p>
                        </div>
                    </div>
