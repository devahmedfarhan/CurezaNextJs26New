    ...
    <section className="container mx-auto px-4 md:px-6 py-12 md:py-16 bg-[#F8F3EF] text-[#052326]">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-5">
          ...
          <p className="text-sm text-[#052326]/90 mt-4 font-light leading-relaxed">
          ...
          <div className="mt-8 space-y-3">
            <label className="text-xs font-bold uppercase tracking-wider text-[#052326]/80">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="flex justify-between items-center pb-2 border-b border-[#052326]/10">
            <span className="text-xs font-bold uppercase tracking-wider text-[#052326]/80">
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <div className="relative w-16 h-16 md:w-20 md:h-20 rounded-[8px] overflow-hidden bg-gray-100 flex-shrink-0">
                    ...
                    />
                    {doc.online && (
                      <span className="absolute bottom-1 right-1 w-3.5 h-3.5 rounded-full bg-emerald-500 border-2 border-white z-10" />
                    )}
                  </div>
                  <div>
                    ...
                    <p className="text-xs text-[#052326]/90 font-light mt-0.5 leading-relaxed">
                      {doc.specialty}
                    </p>
                    <div className="flex flex-wrap items-center gap-3 mt-2 text-xs">
                      <span className="text-[#052326]/80 font-medium">{doc.experience}</span>
                      <div className="h-3 w-[1px] bg-gray-300" />
                      <div className="flex items-center gap-1 font-bold text-[#052326]">
                        <Star size={12} className="text-[#F0C417] fill-[#F0C417]" />
                        {doc.rating}
                        <span className="text-[#052326]/75 font-normal">({doc.reviews})</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex md:flex-col items-center md:items-end justify-between w-full md:w-auto pt-4 md:pt-0 border-t md:border-t-0 border-[#052326]/5 gap-4">
                  <div className="text-left md:text-right">
                    <span className="text-[10px] uppercase font-bold tracking-wider text-[#052326]/75 block">Fee</span>
                    <span className="text-lg font-bold">{doc.fee}</span>
                    <span className="text-[10px] text-emerald-800 block font-semibold mt-0.5">{doc.availability}</span>
                  </div>
                  <Link
