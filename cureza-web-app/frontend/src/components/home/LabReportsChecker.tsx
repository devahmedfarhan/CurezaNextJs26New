      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-5">
          ...
          <div className="grid grid-cols-3 gap-4 mt-8 pt-8 border-t border-[#052326]/10 text-center">
            <div>
              ...
              <div className="text-[9px] uppercase tracking-wider text-[#052326]/60 font-semibold mt-1">THC Content</div>
            </div>
            <div className="border-x border-gray-200">
              <div className="text-xl font-bold">100%</div>
              <div className="text-[9px] uppercase tracking-wider text-[#052326]/60 font-semibold mt-1">Non-GMO</div>
            </div>
            <div>
              <div className="text-xl font-bold">ISO</div>
              <div className="text-[9px] uppercase tracking-wider text-[#052326]/60 font-semibold mt-1">Accredited</div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 bg-[#F8F3EF] p-6 md:p-8 rounded-[8px] border border-gray-200/50">
          ...
          <div className="mt-6 min-h-[220px] flex items-center justify-center border border-dashed border-[#052326]/10 rounded-[8px] bg-white/50 p-4">
            {!searched && (
              <div className="text-center p-6 text-[#052326]/60">
            ...
            {searched && result && (
              <div className="w-full space-y-4">
                <div className="flex justify-between items-center pb-3 border-b border-gray-200">
                  <div>
                    <span className="text-[10px] uppercase font-bold tracking-wider text-[#052326]/50 block">Product</span>
                    <span className="text-sm font-bold text-[#052326]">{result.productName}</span>
                  </div>
                  <div className="text-right">
                    <span className="text-[10px] uppercase font-bold tracking-wider text-[#052326]/50 block">Batch Code</span>
                ...
                <div className="grid grid-cols-2 gap-4 text-xs">
                  <div>
                    <span className="text-[#052326]/60 block font-light">Verification Purity Score</span>
                  ...
                  <div>
                    <span className="text-[#052326]/60 block font-light">Pesticide Residue</span>
                    <span className="font-semibold text-emerald-600 flex items-center gap-1 mt-0.5">
                      <Check size={12} />
                      {result.pesticides}
                    </span>
                  ...
                  <div>
                    <span className="text-[#052326]/60 block font-light">Heavy Metals Check</span>
                    <span className="font-semibold text-emerald-600 flex items-center gap-1 mt-0.5">
                      <Check size={12} />
                      {result.heavyMetals}
                    </span>
                  ...
                  <div>
                    <span className="text-[#052326]/60 block font-light font-light">Verified Date</span>
                  ...
                  {result.cbdContent && (
                    <div>
                      <span className="text-[#052326]/60 block font-light">CBD Cannabinoid</span>
                      <span className="font-semibold mt-0.5 text-[#052326] block">{result.cbdContent}</span>
                    </div>
                  )}
                  {result.thcContent && (
                    <div>
                      <span className="text-[#052326]/60 block font-light">THC Psychoactive</span>
