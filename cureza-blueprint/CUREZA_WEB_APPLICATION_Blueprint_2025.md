...
| :--- | :--- | :--- |
| **Cureza Green** | #2E7D32 | Primary Brand Color (Buttons, Links, Logos). Represents nature and health. |
...
*   **Buttons:**
    *   *Primary:* Solid Cureza Green, rounded corners (8px).
    *   *Secondary:* Outlined Green.
    *   *CTA:* Floating Action Button (FAB) for 'Chat with Doctor' on mobile.
*   **Cards:**
    *   *Product Card:* Clean white card with subtle shadow on hover, large product image, clear price, and 'Add' button.
    *   *Doctor Card:* Profile picture, verification badge, specialty tags, and 'Book' button.
*   **Forms:**
...
*   *Excludes: GST (18%), Marketing budget, and ongoing maintenance after launch.*
